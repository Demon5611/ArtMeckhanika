      ...
      <Container>
        <div className="containerText">
          ...
          <p>
            ...
            острых социальных вопросов, не касающихся тем политики и религии. Моя цель – человек,
          ...
          <h3  style={{marginTop:'7ch'}}>
            Серийное производство</h3>
          <div className='textMainImg3'>
          К процессу создания своих работ отношусь очень внимательно и скрупулезно, так как картины,
          чаще всего, создаю сериями. За каждым проектом стоит тщательно собранный исторический,
          художественный, а иногда и научный материал. Картины воплощаю преимущественно в графике.
          Выбор техники исполнения -коллаж, масло, акварель, цифровая иллюстрация, фото-зависит от
          проекта в целом и его концепции. Пример такой работы - серия картин «Обратный процесс
          эволюции», 2021 год.
          <a href={NataAvodesBio} style={{ float:'left', marginTop: '1ch', textIndent: '0ch'}} className="cv" download="NataAvodes-bio.pdf">
            Скачать NataAvodes-bio.pdf
          </a>
          </div>
        </div>
      </Container>
